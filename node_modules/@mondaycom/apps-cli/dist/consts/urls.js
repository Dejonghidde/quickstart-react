...
export const createAppFromManifestUrl = () => {
    return `${BASE_APPS_URL}/manifest`;
};
export const updateAppFromManifestUrl = (appId) => {
    return `${BASE_APPS_URL}/${appId}/manifest`;
};
export const exportAppManifestUrl = (appId) => {
    return `${BASE_APPS_URL}/${appId}/manifest?zipBase64=true`;
};
export const makeAppManifestExportableUrl = (appId) => {
